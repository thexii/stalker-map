...
export class StalkerComponent {
  ...
  public copyLink(): void {
    let link = `${window.location.origin}/map/${this.game.uniqueName}?lat=${this.stalker.z}&lng=${this.stalker.x}&type=stalkers${this.isUnderground ? `&underground=${this.stalker.locationId}` : ''}`;
