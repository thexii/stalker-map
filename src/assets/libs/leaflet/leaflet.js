...
(this, function (t) {
    ...
    function ZStalker(t, e) {
        t._leaflet_pos = e,
        b.any3d ? be(t, e) : (t.style.left = e.x + "%", t.style.top = e.y + "%")
    }
    ...
    qe = (A.include({
            ...
            _initLayout: function () {
                ...
                i || this.expand(),*/
                this._overlaysList = document.getElementById("layers-control")
            ...
            _update: function () {
                if (this._container) {
                    ...
                    for (var t, e, i, n = 0, o = 0; o < this._layers.length; o++)
                        i = this._layers[o], this._addItem(i, o), e = e || i.overlay, t = t || !i.overlay, n += i.overlay ? 0 : 1;
            ...
            _addItem: function (t, index) {
                var e, newCheckbox, checkboxLabel,
                i = document.createElement("div"),
                checkboxLabel = document.createElement("label"),
                n = this._map.hasLayer(t.layer),
                n = (t.overlay ? ((e = document.createElement("input")).type = "checkbox", e.className = "leaflet-control-layers-selector", e.id = `layer-${index}`, e.hidden = true, e.defaultChecked = n) : e = this._createRadioElement("leaflet-base-layers_" + h(this), n), this._layerControlInputs.push(e), e.layerId = h(t.layer), S(e, "click", this._onInputClick, this), document.createElement("span")),
                o = (n.innerHTML = " " + t.name, document.createElement("span"));
                i.appendChild(checkboxLabel)
                return checkboxLabel.appendChild(o),
                o.appendChild(e),
                (t.overlay ? this._overlaysList : this._baseLayersList).appendChild(i),
                this._checkDisabledLayers(),
                i.classList.add('sub-header-panel'),
                newCheckbox = document.createElement("label"),
                newCheckbox.setAttribute('for', `layer-${index}`),
                o.appendChild(newCheckbox),
                o.appendChild(n),
                o.setAttribute('for', `layer-${index}`),
                checkboxLabel.classList.add('sub-header-checkbox')
            },
            _onInputClick: function () {
                ...
                for (s = 0; s < o.length; s++) {
                    this._map.hasLayer(o[s]) && this._map.removeLayer(o[s]) && o[s].hide(o[s]);
                }
    ...
    piStalker = pi.extend({
        ...
        _setPos: function (t) {
            this._icon && ZStalker(this._icon, t),
            this._zIndex = t.y + this.options.zIndexOffset,
            this._resetZIndex()
        },
        _updateZIndex: function (t) {
    ...
    Yi = (A.addInitHook("addHandler", "touchZoom", Ot), A.BoxZoom = _t, A.DoubleClickZoom = Ct, A.Drag = Zt, A.Keyboard = St, A.ScrollWheelZoom = Et, A.TapHold = kt, A.TouchZoom = Ot, t.Bounds = f, t.Browser = b, t.CRS = ot, t.Canvas = Fi, t.Circle = gi, t.CircleMarker = fi, t.Class = et, t.Control = B, t.DivIcon = Ii, t.DivOverlay = Oi, t.DomEvent = mt, t.DomUtil = pt, t.Draggable = Je, t.Evented = it, t.FeatureGroup = ui, t.GeoJSON = xi, t.GridLayer = Ri, t.Handler = n, t.Icon = ci, t.ImageOverlay = Si, t.LatLng = v, t.LatLngBounds = s, t.Layer = o, t.LayerGroup = li, t.LineUtil = gt, t.Map = A, t.Marker = pi, t.Mixin = ft, t.Path = mi, t.Point = p, t.PolyUtil = vt, t.Polygon = yi, t.Polyline = vi, t.Popup = Ai, t.PosAnimation = We, t.Projection = wt, t.Rectangle = Ki, t.Renderer = Hi, t.SVG = qi, t.SVGOverlay = ki, t.TileLayer = Ni, t.Tooltip = Bi, t.Transformation = at, t.Util = tt, t.VideoOverlay = Ei, t.bind = a, t.bounds = _, t.canvas = Wi, t.circle = function (t, e, i) {
        ...
        return new pi(t, e)
    }, t.markerStalker = function (t, e) {
        return new piStalker(t, e)
