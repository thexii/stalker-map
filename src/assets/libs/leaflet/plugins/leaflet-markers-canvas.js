  ...
  var markersCanvas = {
    ...
    _redraw: function _redraw(clear) {
      ...
      this._positionsTree.search(mapBoundsBox).forEach(function (ref) {
        ...
        marker.options.icon.options.iconSize = [ref$2.iconSizeInit[0] * markWidth, ref$2.iconSizeInit[1] * markWidth]
        var iconSize = ref$2.iconSize;
        var iconAnchor = [ref$2.iconSizeInit[0] * markWidth / 2, ref$2.iconSizeInit[1] * markWidth / 2];
        ...
        this$1._drawMarker(marker, { x: markerBox.minX, y: markerBox.minY });
      });
